...
{
    private const BASE_URL = 'https://justanotherpanel.com/api/v2';
    ...
    public function getName(): string { return 'JustAnotherPanel'; }
    ...
    public function createOrder(string $serviceId, string $link, int $quantity, array $extra = []): string
    {
        ...
        if (isset($data['error'])) {
            throw new \RuntimeException('JustAnotherPanel error: ' . $data['error']);
        }
